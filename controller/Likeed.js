    ...
    const data = [
      ...
      },
      {
        $unset: [
          ...
          "__v",
          "Liked_users.email",
          "Liked_users.password",
          "Liked_users.gender",
          "Liked_users.verification_code",
          "Liked_users.user_is_forgot",
          "Liked_users.user_authentication",
          "Liked_users.user_device_token",
          "Liked_users.user_device_type",
          "Liked_users.is_notification",
          "Liked_users.createdAt",
          "Liked_users.updatedAt",
          "Liked_users.__v",
          "Liked_users.address",
          "Liked_users.city",
          "Liked_users.dob",
          "Liked_users.state",
          "Liked_users.role",
          "Liked_users.is_verified",
          "Liked_users.user_is_profile_complete",
          "Liked_users.is_Blocked",
